    ...
    const subcategories = [
        {
            ...
            nested: [
                ...
                { 
                    ...
                    fileId: "1e6k1tjf-1e6k1tjf-1A7mEatDrs0n3AOmtXNBOyoQ", 
                    type: "ppt" 
                },
                { 
                    id: 15, 
        ...
        },
        {
            ...
            nested: [
                { 
                    ...
                    title: "Lecture 1 Slides", 
                    path: "lecture-1-slides", 
                    fileId: "6iC5gz1slBCKLfvSogBpWg9Y8kOIdHKMt", 
                    type: "ppt" 
                },
                { 
                    id: 22, 
                    title: "Lecture 2 Slides", 
                    path: "lecture-2-slides", 
                    fileId: "7jD6ha2tmCDLMgwTphCqXh0Z9lPJeILNu", 
                    type: "ppt" 
                },
                { 
                    id: 23, 
        ...
        },
        {
            ...
            nested: [
                { 
                    ...
                    title: "Lecture 1 Slides", 
                    path: "lecture-1-slides", 
                    fileId: "8kE7ib3unDEMNhwUqiDrYi1A0mQKfJMOv", 
                    type: "ppt" 
                },
                { 
                    id: 32, 
                    title: "Lecture 2 Slides", 
                    path: "lecture-2-slides", 
                    fileId: "9lF8jc4voEFNOixVrjEsZj2B1nRLgKNQw", 
                    type: "ppt" 
                },
                { 
                    id: 33, 
    ...
    return (
        <div className="flex h-screen bg-background text-foreground">
            ...
            <div className="flex-1 p-4 flex flex-col items-center justify-center">
                <h1 className="text-2xl font-bold mb-4 text-center">Industrial Metaverse Teaching Kit</h1>
                {selectedFileId && (
